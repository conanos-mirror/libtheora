...
class LibtheoraConan(ConanFile):
    ...
    def source(self):
        ...
        shutil.copyfile('theora.def', os.path.join(self._source_subfolder, 'lib','theora.def'))
        ...
        if self.settings.compiler == 'Visual Studio':
            ...
            if self.settings.os == "Windows":
                for s, r in {"@prefix@" : self.package_folder,
                         ...
                         tools.replace_in_file(os.path.join(self.source_folder, self._source_subfolder, 'theora.pc.in'),s,r)
                         tools.mkdir(os.path.join(self.package_folder, "lib", "pkgconfig"))
                         shutil.copy2(os.path.join(self.source_folder, self._source_subfolder, 'theora.pc.in'),
